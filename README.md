...
- [**create-pr**](skills/create-pr/SKILL.md) — Creates a GitHub pull request by analyzing branch changes and generating a summary, following repo PR templates when available.
